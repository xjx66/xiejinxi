...
import { DeleteVolumeDataRequest, RetryRunsResponse, RunApplicationResponse, DescribeRunsResponse, ImportTableFileResponse, RunApplicationRequest, GetRunMetadataFileResponse, CreateVolumeResponse, DeleteEnvironmentResponse, GetRunCallsRequest, RunWorkflowRequest, DescribeRunsRequest, CreateVolumeRequest, DescribeTablesRowsRequest, DescribeEnvironmentsResponse, ModifyVolumeResponse, DescribeTablesResponse, ImportTableFileRequest, DeleteVolumeResponse, TerminateRunGroupResponse, DescribeVolumesResponse, DeleteVolumeRequest, RetryRunsRequest, DeleteEnvironmentRequest, GetRunCallsResponse, DescribeRunGroupsResponse, TerminateRunGroupRequest, GetRunStatusRequest, DescribeTablesRowsResponse, CreateEnvironmentResponse, GetRunMetadataFileRequest, RunWorkflowResponse, ModifyVolumeRequest, DescribeRunGroupsRequest, GetRunStatusResponse, DescribeTablesRequest, DeleteVolumeDataResponse, DescribeEnvironmentsRequest, DescribeVolumesRequest, CreateEnvironmentRequest } from "./omics_models";
/**
 * omics client
 * @class
 */
